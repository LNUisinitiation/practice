...
//	}
//}
//package JAVA_eclipse; //正确的写法应该是javaeclipse
//
//import java.util.Scanner; //导包
//
//public class HelloWorld{
...
//		 //char cMonth = month.charAt(0);
//		 switch(month) {
//		 case "3": //因为switch接收一个char类型的变量，所以这里要记得加''，表示字符常量
...
//		 }
//		int num = 1;
//		for(System.out.print('a');num <= 3;System.out.print('c'),num++) { //如果有多条可以用逗号隔开
//			System.out.print('b');		
//		}
//		int sum = 0;
//		int count = 0; //记录偶数的个数
...
//				System.out.println("偶数的和为:" + count);
//		
//		for(int i = 1;i <= 150;i++) {
//				System.out.print(i);
//				if(i % 3 == 0) {
...
//		System.out.println(str2);
//		System.out.println("请输入一个浮点型变量");
//		double d1 = scan.nextDouble();
//		System.out.println(d1);
//		System.out.println("请输入一个char型变量");
...
//		char c2 = str4.nextAt(0);
//	}
//}
//package JAVA_eclipse; //这里规范的写法应该是package javaeclipse;
////导包
//import java.util.Scanner;
//public class HelloWorld{
//	public static void main(String[] args) {
...
//}
//求12和20的最大公约数和最小公倍数
//package JAVA_eclipse; //这里规范的写法是package javaeclipse;
//import java.util.Scanner; //导包
//public class HelloWorld{
//	public static void main(String[] args) {
//		//new一个Scanner类的对象
//		Scanner scan = new Scanner(System.in);
//		//第一步先求12和20的最大公约数，也就是拿两者中最大的那个数，从大到小循环，利用break来跳出循环
//		System.out.println("请输入第一个正整数:");
//		int m = scan.nextInt();
//		System.out.println("请输入第二个正整数:");
//		int n = scan.nextInt();
//		
//		int min = (m <= n) ? m : n; //m和n中最小的那个数
//		
//		for(int i = min;i >= 1;i--) {
//			if(m % i == 0 && n % i == 0) {
//				System.out.println("最大公约数为:" + i);
...
//20210403 周六
//求12和20的最大公约数和最小公倍数
//package JAVA_eclipse; //规范的写法应该是package javaeclipse;
//
//import java.util.Scanner;
//
//public class HelloWorld{
...
//}
//20210405 周一
//package JAVA_eclipse; //规范的写法是package javaeclipse;
//import java.util.Scanner;
//public class HelloWorld{
//	public static void main(String[] args) {
//		//new一个Scanner类的对象
...
//public class HelloWorld{
//	public static void main(String[] args) {
//		//输出三位的水仙花数153==1*1*1+3*3*3+5*5*5   //i%10 个位   i\10\10 百  i\10%10 十
////		for(int i = 100;i < 1000;i++) {
////			int sum = (i%10)*(i%10)*(i%10)+(i/100)*(i/100)*(i/100)+(i/10%10)*(i/10%10)*(i/10%10);
////			if(i == sum)  //除法运算符是 /   不是 \
////			System.out.println("所有的水仙花数为:" + i);	 //时间复杂度是O(n)
//			
//		for(int i = 100;i < 1000;i++) {
//			int sum1 = (i%10)*(i%10)*(i%10)+(i/100)*(i/100)*(i/100)+(i/10%10)*(i/10%10)*(i/10%10);
//			if(i == sum1) {
//				System.out.println("三位的水仙花数:" + i);
//				}
//			}
//		}
//}
...
//			if(number > 0) {
//				positiveNumber++;
//				System.out.println("positiveNumber的个数:" + positiveNumber);
//			}else if(number < 0) {
//				negativeNumber++;
//				System.out.println("negativeNumber的个数:" + negativeNumber);
//			}else
//				break;
//		}
//		System.out.println("positiveNumber总的个数:" + positiveNumber);
//		System.out.println("negativeNumber总的个数:" + negativeNumber);
//	}
//}
//package JAVA_eclipse;
//public class HelloWorld{
...
//			
//			boolean isFlag = true;//标识i是否被j除尽，一旦除尽，修改其值
//			//优化二:对本身是质数的自然数是有效的 Math.sqrt(i)
...
//public class HelloWorld{
//	public static void main(String[] args) {
//	label:for(int i = 1;i < 10;i++) { //带标签的break和continue
//			for(int j = 1;j < 10;j++) {
//				if(j % 4 == 0) {
//					break label;	
//				}
...
//public class HelloWorld{
//	public static void main(String[] args) {
//		//求1000以内的所有完数 6=1+2+3
//		int sum = 0;
//		for(int i = 1;i <= 1000;i++) {
//			for(int j = 1;j < i;j++) { //优化:j <= i/2
//				if(i % j == 0) { //如果能整除，那么j就是它的因子
//					sum += j;
//				}
//			}
//			if(i == sum)
...
//		//外层循环控制行数，内层循环控制列数
//		for(int i =1;i <= 6;i++) {
//			for(int j = 6;j >= i;j--) { //规律: 		i和j的和不变，i+j=7  j <= 7 - i
//				System.out.print("*");
//			}
//			System.out.println();
//			
...
public class HelloWorld{
	public static void main(String[] args) { //main alt + /
		System.out.println("HelloWorld"); //syso alt + /
	}
}

...
//		//t1.show(1);
//		//t1.show("hello");
//		t1.show(new String[]{"hello","nihao","jiayou"});
//		//t1.show(2);
//	}
//	//方法
...
//		Test t1 = new Test();
//		//t1.swap(m, n);
//		int result = t1.swap(m, n);
//		//System.out.println(result);
//		//System.out.println("m = " + m + ",n = " + n);
//	}
//	
//	public int swap(int m,int n) {
//		int temp = m;
//		m = n;
//		n = temp;
...
//		data.eat();
//		
//		//因为在main方法中调用，所以必须创建对象之后，用对象调用属性和方法
//		Test t1 = new Test();
//		
//		t1.swap(data);
//		System.out.println("m = " + data.m + ",n = " + data.n);
